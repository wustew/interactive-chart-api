...
def chart():
    ...
    fig.add_hline(y=-0.05, line=dict(color='red', width=1, dash='dash'),
                  annotation_text="Early Bearish Threshold", annotation_position="right",
                  row=2, col=1)
    fig.add_hline(y=-0.15, line=dict(color='darkred', width=1, dash='dash'),
                  annotation_text="Strong Bearish Zone", annotation_position="right",
                  row=2, col=1)
